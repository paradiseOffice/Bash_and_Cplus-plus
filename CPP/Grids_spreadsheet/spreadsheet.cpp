...
bool Spreadsheet::readFile(const QString &fileName)
{
	...
	QMessageBox::warning(this, tr("Spreadsheet"), tr("This file isn't a *.sp spreadsheet file."));
	return false;
    }
...
void Spreadsheet::cutItem()
{
    copyItem();
    deleteItem();
}

void Spreadsheet::copyItem()
{
...
void Spreadsheet::pasteItem()
{
	...
	QMessageBox::information(this, tr("Grids"), tr("There's no space to paste those cells - sorry."));
	return;
    }
